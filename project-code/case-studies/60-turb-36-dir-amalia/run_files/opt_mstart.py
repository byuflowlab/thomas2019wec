...
from plantenergy.GeneralWindFarmComponents import calculate_distance, calculate_boundary
...
if __name__ == "__main__":
    ...
    layout_data = np.loadtxt(layout_directory + "layouts/amalia_60turbs/nTurbs60_spacing5_layout_%i.txt" % layout_number)
