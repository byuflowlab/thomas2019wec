...
concatenated_calc = pd.concat([dfopt_wec.assign(dataset='SNOPT+WEC-D')])
...
g = sns.relplot(x='Function Calls', y='AEP', kind="line", data=dfcalc_wec)
h = sns.relplot(x='Function Calls', y='AEP', kind="line", data=dfopt_wec)
