...
velocityFile = open('../DataFiles/Jensen3DVelocityOverWindspeed.txt', 'w+')
...
MyJensenCosineVelocity16 = np.loadtxt('../DataFiles/MyJensenCosineModelVelocity16.txt')
MyJensenCosineVelocity10 = np.loadtxt('../DataFiles/MyJensenCosineModelVelocity10.txt')
MyJensenCosineVelocity6 = np.loadtxt('../DataFiles/MyJensenCosineModelVelocity6.txt')
MyThetaVector = np.loadtxt('../DataFiles/MyJensenModelThetaVector.txt')
...
velocityFile = open('../DataFiles/Jensen3DVelocityOverWindspeed.txt', 'r')
...
for i in range(x_over_ro.size):
    ...
    for j in range(thetaVector.size):
        ...
        # wake velocity we calculated by the wind_speed. This has been taken care of when the velocity was first
        # calculated and written to the file.
